...
// File name: projects/02/ALUnostat.tst

// ALUnostat.tst provides a partial test of the ALU chip.
// It IS NOT a replacement for ALU.tst.

// ALUnostat.tst tests only the computation part of the ALU.
...
// Once your ALU passes ALUnostat.tst you need to test it with ALU.tst.
